...
function TServerMethods1(connectionInfo)
{
  ...
  this.GetPessoa = function() {
    var returnObject = this.executor.executeMethod('GetPessoa', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.GetPessoa_URL = function() {
    return this.executor.getMethodURL("GetPessoa", "GET", [], arguments[0])[0];
  };

  /*
   * @param _value [in] - Type on server: TJSONValue
   * @return result - Type on server: TJSONValue
   */
  this.PostPessoa = function(_value) {
    var returnObject = this.executor.executeMethod('"PostPessoa"', "POST", [_value], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject._value = _value;
        resultObject.result = resultArray[0];
        if (returnObject.cacheId != null && returnObject.cmdIndex != null) {
          resultObject._cacheId = returnObject.cacheId;
          resultObject._cmdIndex = returnObject.cmdIndex;
...
var JSProxyClassList = {
  ...
  "TServerMethods1": ["EchoString","ReverseString","GetPessoa","PostPessoa"]
};
